...
contract ExchangeState is Owned, State, IExchangeState {
    ...
    function getLengthOfEntries(address account, bytes32 currencyKey) external view override returns (uint) {
    ...
    function getMaxTimestamp(address account, bytes32 currencyKey) external view override returns (uint) {
