...
contract SystemStatus is Owned, ISystemStatus {
    mapping(bytes32 => mapping(address => Status)) public override accessControl;
    ...
    Suspension public override systemSuspension;

    Suspension public override issuanceSuspension;

    Suspension public override exchangeSuspension;

    mapping(bytes32 => Suspension) public override synthExchangeSuspension;

    mapping(bytes32 => Suspension) public override synthSuspension;
    ...
    function requireSynthsActive(bytes32 sourceCurrencyKey, bytes32 destinationCurrencyKey) external view override {
        // Synth exchange and transfer requires the system be active
        _internalRequireSystemActive();
    ...
    function requireExchangeBetweenSynthsAllowed(bytes32 sourceCurrencyKey, bytes32 destinationCurrencyKey)
        external
        view
        override
    {
    ...
    function _internalRequireSystemActive() internal view {
        require(
            ...
            systemSuspension.reason == SUSPENSION_REASON_UPGRADE
                ? "DPassive is suspended, upgrade in progress... please stand by"
                : "DPassive is suspended. Operation prohibited"
        );
    }
