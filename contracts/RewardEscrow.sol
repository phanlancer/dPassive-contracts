...
contract RewardEscrow is Owned, IRewardEscrow {
    ...
    /* An account's total escrowed dpassive balance to save recomputing this for fee extraction purposes. */
    mapping(address => uint) public override totalEscrowedAccountBalance;

    /* An account's total vested reward dpassive. */
    mapping(address => uint) public override totalVestedAccountBalance;

    /* The total remaining escrowed balance, for verifying the actual dpassive balance of this contract against. */
    ...
    /**
     * @notice set the dpassive contract address as we need to transfer DPS when the user vests
     */
