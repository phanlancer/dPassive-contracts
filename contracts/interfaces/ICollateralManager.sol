...
interface ICollateralManager {
    ...
    function totalLong() external view returns (uint dUSDValue, bool anyRateIsInvalid);

    function totalShort() external view returns (uint dUSDValue, bool anyRateIsInvalid);
