...
contract FlexibleStorage is ContractStorage, IFlexibleStorage {
    ...
    function getUIntValue(bytes32 contractName, bytes32 record) external view override returns (uint) {
        return uintStorage[hashes[contractName]][record];
    }

    function getUIntValues(bytes32 contractName, bytes32[] calldata records) external view override returns (uint[] memory) {
    ...
    function getIntValue(bytes32 contractName, bytes32 record) external view override returns (int) {
        return intStorage[hashes[contractName]][record];
    }

    function getIntValues(bytes32 contractName, bytes32[] calldata records) external view override returns (int[] memory) {
    ...
    function getAddressValue(bytes32 contractName, bytes32 record) external view override returns (address) {
    ...
    function getBoolValue(bytes32 contractName, bytes32 record) external view override returns (bool) {
        return boolStorage[hashes[contractName]][record];
    }

    function getBoolValues(bytes32 contractName, bytes32[] calldata records) external view override returns (bool[] memory) {
    ...
    function getBytes32Value(bytes32 contractName, bytes32 record) external view override returns (bytes32) {
